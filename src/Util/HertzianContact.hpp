...
// Hertzian contact class for contact mechanics of a rigid, spherical indentor on an infinite
// plane based on (Johnson, 1985), (Barber, 2018), and (Joodaki, 2018). 
// Janelle Clark - October, 2021
